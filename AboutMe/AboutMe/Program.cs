    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string developerInfo = "Project Developer: David Aaron" + "\n\n" + "Project Start Date: June 2017" +
                "\n\n" +"Head over to https://kingdavid.xyz for more info about me :) \n";

            string message = (userOptionChoice == "2") ? developerInfo : generalInfo;

            Console.WriteLine("\n" + message);
            Console.WriteLine("Check out the rest of the repository! Feel free to contact me (see Option 2 for details) with any projects you think I may be interested in :D." +
                "\n\n" + "Hit the <Enter> key or Ctrl-C to exit...");
            Console.ReadLine();
        }
    }
}